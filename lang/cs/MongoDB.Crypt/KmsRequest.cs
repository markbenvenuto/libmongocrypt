...
namespace MongoDB.Crypt
{
    ...
    /// </summary>
    /// <seealso cref="MongoDB.Crypt.IStatus" />
    public class KmsRequest : IStatus
    {
        ...
        /// </summary>
        /// <param name="str">The response.</param>
        public void Feed(string str)
        {
            ...
            try
            {
                using (PinnedBinary pinned = new PinnedBinary(stringPointer, (uint)CryptClient.Strlen(stringPointer)))
                {
