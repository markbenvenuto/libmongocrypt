...
namespace MongoDB.Crypt
{
    ...
    public class Library
    {
        ...
        {
            // Bool is expected to be 4 bytes during marshalling so we need to overwite it
            ...
            public delegate bool mongocrypt_setopt_log_handler(MongoCryptSafeHandle handle, IntPtr log_fn, IntPtr log_ctx);
            [return: MarshalAs(UnmanagedType.I1),]
            public delegate bool mongocrypt_setopt_kms_provider_aws(MongoCryptSafeHandle handle, [MarshalAs(UnmanagedType.LPStr)]string aws_access_key_id, [MarshalAs(UnmanagedType.LPStr)] string aws_secret_access_key);
            ...
            [return: MarshalAs(UnmanagedType.I1),]
            public delegate bool mongocrypt_ctx_setopt_masterkey_aws(ContextSafeHandle handle, IntPtr region, uint region_len, IntPtr cmk, uint cmk_len);
            [return: MarshalAs(UnmanagedType.I1)]
            public delegate bool mongocrypt_ctx_status(ContextSafeHandle handle, StatusSafeHandle status);
            [return: MarshalAs(UnmanagedType.I1)]
            public delegate bool mongocrypt_ctx_encrypt_init(ContextSafeHandle handle, IntPtr ns, uint len);
            [return: MarshalAs(UnmanagedType.I1)]
